...
echo ".asm -> .o ..."
nasm -f elf32 ../boot/kernel.asm -o ../src/kasm.o
...
ld -m elf_i386 -T link.ld -o ../iso/boot/kernel.bin ../src/kasm.o ../src/kc.o ../src/terminal.o ../src/io.o ../src/utils.o ../src/keyboard.o
